  ...
  return (
    <section className="relative flex min-h-screen items-center justify-center overflow-hidden pt-16">
      ...
      <div className="relative z-10 mx-auto max-w-5xl px-4 text-center">
        ...
        {/* Headline */}
        <h1 className="mb-6 font-display text-4xl font-black leading-tight text-gradient-gold md:text-6xl lg:text-7xl xl:text-8xl">
        ...
        {/* Price badge */}
        <div className="mx-auto mb-8 inline-block rounded-lg border-2 border-gold/40 bg-card/80 px-8 py-5 backdrop-blur-sm">
